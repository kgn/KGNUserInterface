...
class KGNUserInterfaceLabelTests: XCTestCase {
    ...
    func testAppearanceTextColor() {
        let label1 = Label()
        XCTAssertEqual(label1.textColor, .black)

        Label.appearance().textColor = .red
        let label2 = Label()
        XCTAssertEqual(label2.textColor, .red)
    }
...
class KGNUserInterfaceTextFieldTests: XCTestCase {
    ...
    func testAppearanceTextColor() {
        ...
        XCTAssertEqual(textField1.textColor, .black)

        TextField.appearance().textColor = .red
        let textField2 = TextField()
        XCTAssertEqual(textField2.textColor, .red)
    }
